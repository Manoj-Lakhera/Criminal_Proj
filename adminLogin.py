...
class Main:
    def __init__(self):
        ...
        self.txtcolor = "black"
        self.title = tkinter.Label(self.root, text="Admin Login", font=("Arial", "20", "bold"),bg=self.primarycolor,fg=self.txtcolor,width=10)
    ...
    def adminLogin(self):
        ...
        if len(data)==0:
            ...
            self.root.destroy()
            dashboard.admindashboard(admindetails=data)
