...
class Main:
    def __init__(self):
        ...
        self.mainLabel = Label(self.root, text='View Criminal',font=('Arial',28,'bold'))
        ...
        self.btn1 = Button(self.searchFrame, text='Search', font=('Arial', 14), command=self.searchCriminal)
        self.btn1.grid(row=0, column=2, pady=10, padx=10)
        self.btn2 = Button(self.searchFrame, text='Refresh', font=('Arial', 14), command=self.resetCriminal)
    ...
    def updateWindow(self,e):
        ...
        self.title = tkinter.Label(self.root1, text="Update Criminal", font=("Arial", "20", "bold"))
        ...
        self.lb2 = tkinter.Label(self.formFrame, text="Enter Gender", font=self.formFont)
        self.lb2.grid(row=1, column=0, padx=10, pady=10)
        self.txt2 = tkinter.Entry(self.formFrame, font=self.formFont)
        self.txt2.grid(row=1, column=1, padx=10, pady=10)
        self.txt2.insert(0, data[1])

        self.lb3 = tkinter.Label(self.formFrame, text="Enter DOB", font=self.formFont)
        ...
        self.lb4 = tkinter.Label(self.formFrame, text="Enter Address", font=self.formFont)
        ...
        self.lb5 = tkinter.Label(self.formFrame, text="Enter Family_Member", font=self.formFont)
        self.lb5.grid(row=4, column=0, padx=10, pady=10)
        self.txt5 = tkinter.Entry(self.formFrame, font=self.formFont)
        self.txt5.grid(row=4, column=1, padx=10, pady=10)
        self.txt5.insert(0, data[4])

        self.lb6 = tkinter.Label(self.formFrame, text="Enter Member_contact", font=self.formFont)
        self.lb6.grid(row=5, column=0, padx=10, pady=10)
        self.txt6 = tkinter.Entry(self.formFrame, font=self.formFont)
        self.txt6.grid(row=5, column=1, padx=10, pady=10)
        self.txt6.insert(0, data[5])

        self.lb7 = tkinter.Label(self.formFrame, text="Enter Image", font=self.formFont)
        self.lb7.grid(row=6, column=0, padx=10, pady=10)
        self.txt7 = tkinter.Entry(self.formFrame, font=self.formFont)
        self.txt7.grid(row=6, column=1, padx=10, pady=10)
        self.txt7.insert(0, data[6])

        self.lb8 = tkinter.Label(self.formFrame, text="Enter Category", font=self.formFont)
        self.lb8.grid(row=7, column=0, padx=10, pady=10)
        self.txt8 = tkinter.Entry(self.formFrame, font=self.formFont)
