...
class Main:
    def __init__(self):
        ...
        self.title = tk.Label(self.root, text='Add Criminal', font=("Arial", '20', 'bold'))
        ...
        self.lb1 = tk.Label(self.formFrame, text='Enter Name', font=self.formFont)
        self.lb1.grid(row=0, column=0, padx=10, pady=10)
        self.txt1 = tk.Entry(self.formFrame, font=self.formFont)
        self.txt1.grid(row=0, column=1, padx=10, pady=10)

        self.lb2 = tk.Label(self.formFrame, text='Enter Gender', font=self.formFont)
        self.lb2.grid(row=1, column=0, padx=10, pady=10)
        self.txt2 = tk.Entry(self.formFrame, font=self.formFont)
        self.txt2.grid(row=1, column=1, padx=10, pady=10)

        self.lb3 = tk.Label(self.formFrame, text='Enter DOB', font=self.formFont)
        ...
        self.lb5 = tk.Label(self.formFrame, text='Enter Address', font=self.formFont)
        ...
        self.lb6 = tk.Label(self.formFrame, text='Enter Family_Member', font=self.formFont)
        ...
        self.lb7 = tk.Label(self.formFrame, text='Enter Member_contact', font=self.formFont)
        ...
        self.lb8 = tk.Label(self.formFrame, text='Select Image', font=self.formFont)
        ...
        self.btn8 = tk.Button(self.formFrame, text="select", font=self.formFont, command=self.selectImage)
        self.btn8.grid(row=7, column=2, pady=10, padx=10)

        self.lb9 = tk.Label(self.formFrame, text='Select category', font=self.formFont)
        self.lb9.grid(row=8, column=0, padx=10, pady=10)
        self.txt9 = ttk.Combobox(self.formFrame, font=self.formFont, state='readonly')
    ...
    def getFormValues(self):
        ...
        if self.name == '' or self.gender == "" or self.dob == '' or self.mobile == "" or self.address == "" or self.family_member == "" or self.member_contact == "" or self.image == "" or self.category == "":
            ...
            self.cr.execute(q)
            self.conn.commit()
            msg.showwarning("Success", "Criminal has been added")
